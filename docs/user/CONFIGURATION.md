...
This document describes all configuration options and settings available in the Ksenia Lares custom integration.
...
```yaml
service: ksenia.example_service
target:
...
- [GitHub Issues](https://github.com/amg0/ha_ksenia/issues) - Report problems
