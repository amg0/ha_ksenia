# Getting Started with Ksenia Lares

This guide will help you install and set up the Ksenia Lares custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/amg0/ha_ksenia`
6. Set category to "Integration"
7. Click "Add"
8. Find "Ksenia Lares" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/amg0/ha_ksenia/releases)
2. Extract the `ksenia` folder from the archive
3. Copy it to `custom_components/ksenia/` in your Home Assistant configuration directory
...
4. Select entities from "Ksenia Lares"
...
- Report issues at [GitHub Issues](https://github.com/amg0/ha_ksenia/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/amg0/ha_ksenia/discussions)
