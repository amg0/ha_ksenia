...
- **Main code:** `custom_components/ksenia/`
...
- `entity/` — Base entity class (`KseniaLaresEntity`)
...
- Entity MRO: `(PlatformEntity, KseniaLaresEntity)` — order matters
...
- Debug level: `custom_components.ksenia: debug` in `config/configuration.yaml`
